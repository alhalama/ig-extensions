...
namespace IGExtension.WPF.XamDataGrid
{
    public class XamDataGridDragDropRecordMovingBehavior : Behavior<DataPresenterBase>
    {
        ...
        protected override void OnAttached()
        {
            ...
            EventManager.RegisterClassHandler(typeof(Infragistics.Windows.DataPresenter.XamDataGrid), UIElement.MouseLeftButtonDownEvent, new MouseButtonEventHandler(XamDataGrid_MouseLeftButtonDown));
        ...
        private void OnRecordPresenterLoaded(object sender, RoutedEventArgs e)
        {
            ...
            dragSource.DragTemplate = this.DragTemplate;
        ...
        private class DraggingData
        {
            ...
            public IList<IList> Lists { get; set; }
